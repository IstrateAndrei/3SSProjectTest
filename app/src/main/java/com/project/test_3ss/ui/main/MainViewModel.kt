...
class MainViewModel : ViewModel(), KoinComponent {
    ...
    val savedLocationsObservable: MutableLiveData<MutableList<LocationRealmModel>> = MutableLiveData()

    fun getLocalLocations() {
        savedLocationsObservable.value = repository.getLocalLocations()
    }
